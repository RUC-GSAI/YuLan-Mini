...
from transformers.utils.import_utils import is_flash_attn_2_available, is_flash_attn_greater_or_equal
...
def _flash_attention_forward(
    ...
    # then use `flash_attn_varlen_func` to prevent cross-example attention and also allow padding free approach
        ...
        if isinstance(attn_output, tuple):
            attn_output = (attn_output[0].view(batch_size, -1, attn_output[0].size(-2), attn_output[0].size(-1)), *attn_output[1:])
        else:
